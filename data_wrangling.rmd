...
haps19 <- read.csv(here("raw_data/Toxic/daily_HAPS_2019.csv"))
haps20 <- read.csv(here("raw_data/Toxic/daily_HAPS_2020.csv"))
lead19 <- read.csv(here("raw_data/Toxic/daily_LEAD_2019.csv"))
lead20 <- read.csv(here("raw_data/Toxic/daily_LEAD_2020.csv"))
...
vocs19 <- read.csv(here("raw_data/Toxic/daily_VOCS_2019.csv"))
vocs20 <- read.csv(here("raw_data/Toxic/daily_VOCS_2020.csv"))
```
